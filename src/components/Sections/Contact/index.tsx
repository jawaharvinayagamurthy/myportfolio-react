...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-neutral-800 rounded-full" sectionId={SectionId.Contact}>
          ...
          <div className="order-1 col-span-1 flex flex-col gap-y-6 md:order-2">
            ...
            <dl className="flex flex-col space-y-4 text-base text-neutral-500 sm:space-y-2">
              ...
              <div className="flex w-full justify-center gap-x-4"> {actions.map(({href, text, primary, Icon}) => (
                ...
                'flex rounded-full border-2 bg-stone-900 text-sm mt-20 px-10 py-2 font-medium text-white ring-offset-gray-700/80 hover:bg-gray-700/80 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-base ml-auto',
